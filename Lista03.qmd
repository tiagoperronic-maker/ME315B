...
Não são equivalentes pois temos:
not (A and B) = not A or not B
dessa forma a primeira e a terceira cláusulas são equivalentes mas não são equivalentes a segunda cláusula
